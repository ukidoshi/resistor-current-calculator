export class RequestCardComponent {
    ...
    return `
      <div class="card shadow-sm request-card">
        <div class="card-body">
          ...
          <p class="mb-2"><b>Модель:</b> ${data.model}</p>
          ...
          <div class="calc-grid mt-3">
            <div>
              ...
              <button id="add-resistor-btn" class="btn btn-outline-light btn-sm w-100">
                + Добавить резистор
              </button>
            </div>
  ...
  calculate() {
    ...
    formulaEl.innerText = this.connection === "последовательно"
      ? "R = R1 + R2 + ... ; I = U / R"
      : "1/R = 1/R1 + 1/R2 + ... ; I = U / R";
  }
